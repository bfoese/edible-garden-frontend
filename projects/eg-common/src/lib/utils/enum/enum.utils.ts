...
export class EnumUtils {
  public static getKeys<E extends GenericEnum<unknown>>(
    enumClass: E
  ): Array<keyof typeof enumClass> {
  ...
  public static getKeyByValue<E>(
    enumType: GenericEnum<E>,
    enumValue: number | string
  ): keyof typeof enumType | undefined {
    const keys = Object.keys(enumType).filter((x) => enumType[x] === enumValue);
    return keys.length > 0 ? keys[0] : undefined;
  }

  public static toKeyValueObject<E extends GenericEnum<unknown>>(
    enumClass: E
